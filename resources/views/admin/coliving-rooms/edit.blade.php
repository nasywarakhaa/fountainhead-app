...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <h3 class="mb-1"><i class="fas fa-edit mr-2 text-primary"></i>Edit Room: {{ $colivingRoom->name }}</h3>
    ...
    <form action="{{ route('admin.coliving-rooms.update', $colivingRoom) }}" method="POST" enctype="multipart/form-data" id="room-form">
        @csrf
        @method('PUT')
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                    ...
                    <div class="card-body p-4">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old('name', $colivingRoom->name) }}"
                                required
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="room_type" id="room_type" class="form-control @error('room_type') is-invalid @enderror" required>
                                        ...
                                        <option value="single" {{ old('room_type', $colivingRoom->room_type) == 'single' ? 'selected' : '' }}>Single Room</option>
                                        <option value="double" {{ old('room_type', $colivingRoom->room_type) == 'double' ? 'selected' : '' }}>Double Room</option>
                                        <option value="shared" {{ old('room_type', $colivingRoom->room_type) == 'shared' ? 'selected' : '' }}>Shared Room</option>
                                        <option value="suite" {{ old('room_type', $colivingRoom->room_type) == 'suite' ? 'selected' : '' }}>Suite</option>
                                        <option value="dormitory" {{ old('room_type', $colivingRoom->room_type) == 'dormitory' ? 'selected' : '' }}>Dormitory</option>
                                    </select>
                                    @error('room_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="bed_type" id="bed_type" class="form-control @error('bed_type') is-invalid @enderror" required>
                                        ...
                                        <option value="single" {{ old('bed_type', $colivingRoom->bed_type) == 'single' ? 'selected' : '' }}>Single Bed</option>
                                        <option value="double" {{ old('bed_type', $colivingRoom->bed_type) == 'double' ? 'selected' : '' }}>Double Bed</option>
                                        <option value="queen" {{ old('bed_type', $colivingRoom->bed_type) == 'queen' ? 'selected' : '' }}>Queen Bed</option>
                                        <option value="king" {{ old('bed_type', $colivingRoom->bed_type) == 'king' ? 'selected' : '' }}>King Bed</option>
                                        <option value="bunk" {{ old('bed_type', $colivingRoom->bed_type) == 'bunk' ? 'selected' : '' }}>Bunk Bed</option>
                                    </select>
                                    @error('bed_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                ...
                                maxlength="150"
                            >{{ old('short_description', $colivingRoom->short_description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            >{{ old('description', $colivingRoom->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('price_per_night', $colivingRoom->price_per_night) }}"
                                            step="1000"
                                            min="0"
                                            required
                                        >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('weekly_price', $colivingRoom->weekly_price) }}"
                                            step="1000"
                                            min="0"
                                        >
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('monthly_price', $colivingRoom->monthly_price) }}"
                                            step="1000"
                                            min="0"
                                        >
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('capacity', $colivingRoom->capacity) }}"
                                        min="1"
                                        required
                                    >
                                    @error('capacity')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('beds_count', $colivingRoom->beds_count) }}"
                                        min="1"
                                        required
                                    >
                                    @error('beds_count')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('room_size', $colivingRoom->room_size) }}"
                                        step="0.01"
                                        min="0"
                                    >
                                    @error('room_size')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('floor', $colivingRoom->floor) }}"
                                    >
                                    @error('floor')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="bathroom_type" id="bathroom_type" class="form-control @error('bathroom_type') is-invalid @enderror" required>
                                        <option value="private" {{ old('bathroom_type', $colivingRoom->bathroom_type) == 'private' ? 'selected' : '' }}>Private Bathroom</option>
                                        <option value="shared" {{ old('bathroom_type', $colivingRoom->bathroom_type) == 'shared' ? 'selected' : '' }}>Shared Bathroom</option>
                                    </select>
                                    @error('bathroom_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        id="total_units"
                                        class="form-control"
                                        value="{{ old('total_units', $colivingRoom->total_units) }}"
                                        min="1"
                                    >
                            ...
                            <div class="col-md-6">
                                <div class="custom-control custom-checkbox">
                                    <input
                                        ...
                                        value="1"
                                        {{ old('has_window', $colivingRoom->has_window) ? 'checked' : '' }}
                                    >
                            ...
                            <div class="col-md-6">
                                <div class="custom-control custom-checkbox">
                                    <input
                                        ...
                                        class="custom-control-input"
                                        value="1"
                                        {{ old('has_balcony', $colivingRoom->has_balcony) ? 'checked' : '' }}
                                    >
                ...
                <!-- Current Images Card -->
                @if($colivingRoom->thumbnail || $colivingRoom->images)
                <div class="card shadow-sm" style="border-radius: 15px; border: none;">
                    <div class="card-header text-white" style="background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); border-radius: 15px 15px 0 0;">
                        <h5 class="mb-0"><i class="fas fa-image mr-2"></i>Current Images</h5>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3" id="current-thumbnail-wrapper">
                            <label class="d-block font-weight-bold mb-2">Current Thumbnail:</label>
                            <div class="text-center">
                                <div class="image-delete-wrapper" style="max-width: 100%;">
                                    <img
                                        src="{{ Storage::url($colivingRoom->thumbnail) }}"
                                        alt="Thumbnail"
                                        class="img-thumbnail"
                                        style="max-width: 100%; max-height: 300px; object-fit: cover; border-radius: 10px;"
                                    >

                                    <button type="button" class="delete-image-x" id="delete-thumbnail-btn" title="Delete thumbnail">
                        ...
                        <div>
                            <label class="d-block font-weight-bold mb-2">Gallery Images:</label>
                            <div class="row">
                                @foreach($colivingRoom->images as $image)
                                <div class="col-md-3 mb-3 current-gallery-image" id="gallery-image-{{ $loop->index }}">
                                    <div class="image-delete-wrapper">
                                        ...
                                        <button
                                            type="button"
                                            class="delete-image-x delete-gallery-btn"
                                            data-image="{{ $image }}"
                                            data-target="gallery-image-{{ $loop->index }}"
                                            title="Delete image"
                                        >
                                            <i class="fas fa-times"></i>
                                        </button>
                ...
                <div class="card shadow-sm" style="border-radius: 15px; border: none;">
                    <div class="card-header text-white" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); border-radius: 15px 15px 0 0;">
                        <h5 class="mb-0"><i class="fas fa-cloud-upload-alt mr-2"></i>Upload New Images</h5>
                    </div>
                    <div class="card-body p-4">
                        <div class="form-group">
                            <label for="thumbnail" class="font-weight-bold">New Thumbnail Image</label>
                            ...
                            <small class="text-muted d-block mt-2">
                                ...
                                Upload to replace existing thumbnail. Max 2MB.
                            </small>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="images" class="font-weight-bold">Add Gallery Images</label>
                            <div class="custom-file">
                                <input
                                    type="file"
                                    name="images[]"
                            ...
                            <small class="text-muted d-block mt-2">
                                <i class="fas fa-info-circle text-info"></i>
                                New images will be added to existing gallery. Max 2MB per file.
                            </small>
                        </div>
                ...
                <div class="card shadow-sm" style="border-radius: 15px; border: none;">
                    ...
                    <div class="card-body p-4">
                        <div class="form-group">
                            ...
                            >{{ old('cancellation_policy', $colivingRoom->cancellation_policy) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            >{{ old('house_rules', $colivingRoom->house_rules) }}</textarea>
            ...
            <div class="col-lg-4">
                    ...
                    <div class="card-body p-4">
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input
                                    ...
                                    class="custom-control-input"
                                    value="1"
                                    {{ old('is_available', $colivingRoom->is_available) ? 'checked' : '' }}
                                >
                        ...
                        <div class="form-group mt-3">
                            <div class="custom-control custom-switch">
                                <input
                                    ...
                                    class="custom-control-input"
                                    value="1"
                                    {{ old('is_featured', $colivingRoom->is_featured) ? 'checked' : '' }}
                                >
                        ...
                        <div class="form-group mt-4">
                            ...
                            <input
                                ...
                                id="sort_order"
                                class="form-control"
                                value="{{ old('sort_order', $colivingRoom->sort_order) }}"
                            >
                ...
                <div class="card shadow-sm" style="border-radius: 15px; border: none;">
                    ...
                    <div class="card-body p-4">
                        ...
                        @php
                            $facilities = old('facilities', $colivingRoom->facilities ?? []);
                        @endphp
                        <div class="custom-control custom-checkbox mb-2">
                            <input type="checkbox" name="facilities[]" value="AC" id="fac_ac" class="custom-control-input" {{ in_array('AC', $facilities) ? 'checked' : '' }}>
                            <label class="custom-control-label" for="fac_ac">
                                <i class="fas fa-wind text-info mr-1"></i> Air Conditioning
                            </label>
                        </div>
                        <div class="custom-control custom-checkbox mb-2">
                            <input type="checkbox" name="facilities[]" value="WiFi" id="fac_wifi" class="custom-control-input" {{ in_array('WiFi', $facilities) ? 'checked' : '' }}>
                            <label class="custom-control-label" for="fac_wifi">
                                <i class="fas fa-wifi text-primary mr-1"></i> WiFi
                            </label>
                        </div>
                        <div class="custom-control custom-checkbox mb-2">
                            <input type="checkbox" name="facilities[]" value="TV" id="fac_tv" class="custom-control-input" {{ in_array('TV', $facilities) ? 'checked' : '' }}>
                            <label class="custom-control-label" for="fac_tv">
                                <i class="fas fa-tv text-secondary mr-1"></i> Television
                            </label>
                        </div>
                        <div class="custom-control custom-checkbox mb-2">
                            <input type="checkbox" name="facilities[]" value="Mini Fridge" id="fac_fridge" class="custom-control-input" {{ in_array('Mini Fridge', $facilities) ? 'checked' : '' }}>
                            <label class="custom-control-label" for="fac_fridge">
                                <i class="fas fa-snowflake text-info mr-1"></i> Mini Fridge
                            </label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="facilities[]" value="Water Heater" id="fac_heater" class="custom-control-input" {{ in_array('Water Heater', $facilities) ? 'checked' : '' }}>
                ...
                <div class="card shadow-sm" style="border-radius: 15px; border: none;">
                    ...
                    <div class="card-body p-4">
                        ...
                        @php
                            $amenities = old('amenities', $colivingRoom->amenities ?? []);
                        @endphp
                        <div class="custom-control custom-checkbox mb-2">
                            <input type="checkbox" name="amenities[]" value="Wardrobe" id="ame_wardrobe" class="custom-control-input" {{ in_array('Wardrobe', $amenities) ? 'checked' : '' }}>
                            <label class="custom-control-label" for="ame_wardrobe">
                                <i class="fas fa-door-closed text-brown mr-1"></i> Wardrobe
                            </label>
                        </div>
                        <div class="custom-control custom-checkbox mb-2">
                            <input type="checkbox" name="amenities[]" value="Work Desk" id="ame_desk" class="custom-control-input" {{ in_array('Work Desk', $amenities) ? 'checked' : '' }}>
                            <label class="custom-control-label" for="ame_desk">
                                <i class="fas fa-display text-secondary mr-1"></i> Work Desk
                            </label>
                        </div>
                        <div class="custom-control custom-checkbox mb-2">
                            <input type="checkbox" name="amenities[]" value="Chair" id="ame_chair" class="custom-control-input" {{ in_array('Chair', $amenities) ? 'checked' : '' }}>
                            <label class="custom-control-label" for="ame_chair">
                                <i class="fas fa-chair text-info mr-1"></i> Chair
                            </label>
                        </div>
                        <div class="custom-control custom-checkbox mb-2">
                            <input type="checkbox" name="amenities[]" value="Mirror" id="ame_mirror" class="custom-control-input" {{ in_array('Mirror', $amenities) ? 'checked' : '' }}>
                            <label class="custom-control-label" for="ame_mirror">
                                <i class="fas fa-border-style text-primary mr-1"></i> Mirror
                            </label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="amenities[]" value="Towel" id="ame_towel" class="custom-control-input" {{ in_array('Towel', $amenities) ? 'checked' : '' }}>
...
$(document).ready(function() {
    // Delete current thumbnail using X button
    $('#delete-thumbnail-btn').on('click', function() {
        $('#delete_thumbnail').val('1');
        $('#current-thumbnail-wrapper').addClass('current-image-deleted');

        $('#thumbnail').val('');
        $('#thumbnail').next('.custom-file-label').html('Choose thumbnail image...');
        $('#thumbnail-preview').fadeOut();
    });

    // Delete selected gallery image using X button
    $('.delete-gallery-btn').on('click', function() {
        ...
        $('<input>', {
            ...
            name: 'delete_images[]',
            value: image
        }).appendTo('#deleted-gallery-inputs');

        $('#' + target).addClass('current-image-deleted');
    });
    ...
    $('#room-form').on('submit', function(e) {
        ...
        $(this).find('button[type="submit"]').prop('disabled', true).html('<i class="fas fa-spinner fa-spin mr-2"></i>Updating Room...');
    });
