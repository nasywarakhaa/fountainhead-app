        ...
        <tr>
            ...
            <td class="info-column">
                ...
                <table class="info-table">
                    ...
                    <tr>
                        <td class="info-label">Room Name</td>
                        <td class="info-colon">:</td>
                        <td class="info-value">
                    ...
                    <tr>
                        ...
                        <td class="info-colon">:</td>
                        <td class="info-value">
                            {{ $booking->colivingRoom->room_type }}
                        </td>
                    </tr>
...
`
    ...
    <table class="event-table">
        ...
        <tr>
            ...
            <td class="info-colon">:</td>
            <td class="event-value">
                {{ ucfirst($booking->colivingRoom->room_type) }}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="info-colon">:</td>
            <td class="event-value">
                {{ $booking->colivingRoom->capacity }} Guest{{ $booking->colivingRoom->capacity > 1 ? 's' : '' }}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="info-colon">:</td>
            <td class="event-value">
                Rp {{ number_format($booking->price_per_night, 0, ',', '.') }}
            </td>
        </tr>
